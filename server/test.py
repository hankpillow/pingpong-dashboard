...
#     assert get_tail('100') is None
#     assert get_tail(-100) is None
#     assert get_tail(True) is None
#     assert len(get_tail().split('\n')) == 11
...
#     assert get_head('100') is None
#     assert get_head(-100) is None
#     assert get_head(True) is None
#     assert len(get_head().split('\n')) == 11
...
#     hosts = get_hosts()
#     assert isinstance(hosts, basestring)
#     lhosts = hosts.split('\n')
#     assert len(lhosts) == 3
