...
import {groupByDay, toDate, single} from 'modules/data'
...
class Table extends Component {
	...
	groupByExitCode(){
		return R.groupWith(R.eqProps('exit_code'))
	}

	render({data}) {
		const group = data => groupByDay(toDate(data))
		return <ul>
			{group(data).map(list => {
